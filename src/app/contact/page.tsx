                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '4rem', alignItems: 'start' }}>
                    ...
                    <div style={{ position: 'sticky', top: '8rem' }}>
                        <h1 style={{ fontSize: '3.5rem', fontWeight: 800, marginBottom: '1.5rem', lineHeight: 1.1 }}>
                            Hai să <br /><span className="gradient-text">discutăm.</span>
                        </h1>
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', marginBottom: '3rem', lineHeight: 1.6 }}>
                            Ai nevoie de suport tehnic, o ofertă personalizată sau vrei doar să ne spui salut? Suntem aici pentru tine.
                        </p>
                        ...
                        <div style={{ display: 'grid', gap: '2rem' }}>
                            <div style={contactBoxStyle}>
                                ...
                                <div>
                                    ...
                                    <a href="mailto:contact@shopprint.ro" style={valueStyle}>contact@shopprint.ro</a>
                                </div>
                            </div>
                            ...
                            <div style={contactBoxStyle}>
                                ...
                                <div>
                                    ...
                                    <a href="tel:0750473111" style={valueStyle}>0750 473 111</a>
                                </div>
                            </div>
                            ...
                            <div style={contactBoxStyle}>
                                ...
                                <div>
                                    <p style={labelStyle}>LOCAȚIE</p>
                                    <p style={valueStyle}>Com. Topliceni, nr. 214, Jud. Buzău</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* FORM SIDE */}
                    <div style={{ background: 'white', padding: '4rem', borderRadius: 'var(--radius-3xl)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-xl)' }}>
                        {sent ? (
                            <div style={{ textAlign: 'center', padding: '4rem 0' }}>
                                <div style={{ width: '80px', height: '80px', background: '#f0fdf4', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 2rem', color: '#16a34a' }}>
                                    <Send size={40} />
                                </div>
                                ...
                                <button onClick={() => setSent(false)} className="btn-premium">Trimite alt mesaj</button>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '2rem' }}>
                                ...
                                <button type="submit" className="btn-premium" style={{ width: '100%', height: '4rem', fontSize: '1.1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
...
const iconStyle: React.CSSProperties = { width: '60px', height: '60px', background: 'white', borderRadius: 'var(--radius-xl)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'var(--shadow-sm)', color: 'var(--primary)', border: '1px solid var(--border)' };
...
const valueStyle: React.CSSProperties = { fontSize: '1.1rem', fontWeight: 700, color: 'var(--dark)' };
...
const inputStyle: React.CSSProperties = { width: '100%', height: '3.5rem', padding: '0 1.25rem', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)', background: '#f9fafb', fontSize: '1rem', outline: 'none' };
